  ...
  render() {    
    ...
    return (
      <div className="container">
        <h1 className="text-center my-4">Stock Portfolio (react)</h1>
        <div className="row">
          <div className="col-12">
            ...
            <form className="col-12 mt-2 mb-4" onSubmit={this.addStock}>
              ...
              <input className="mx-2" name="shares_owned" type="number" placeholder="Shares" onChange={this.handleFormChange} value={form.shares_owned} required />
              <input className="mx-2" name="cost_per_share" type="number" placeholder="Cost" onChange={this.handleFormChange} value={form.cost_per_share} required />
              <input className="mx-2" name="market_price" type="number" placeholder="Price" onChange={this.handleFormChange} value={form.market_price} required />
              <button className="btn btn-primary btn-sm">addStock</button>
            </form>
            <div>
              <div className="col-12- col-md-6">
                <h4 className="mb-3">Total Value: $ {portfolio_market_value}</h4>
              </div>
              <div className="col-12 col-md-6">
                <h4 className="mb-3">Total Gain/Loss: $ {portfolio_gain_loss}</h4>
              </div>
            </div>
          </div>
        </div>
